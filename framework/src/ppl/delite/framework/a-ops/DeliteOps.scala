...
// This file contains the user-facing Delite operations, for the low-level
// constructs check DeliteOpsIR.scala.


trait DeliteOpsExp extends DeliteOpsExpIR with DeliteCollectionOpsExp with DeliteMapOpsExp with DeliteArrayFatExp {
   ...
   */
  abstract class DeliteOpLoop[A:Manifest](implicit ctx: SourceContext) extends DeliteOpAbstractLoop[A] {
